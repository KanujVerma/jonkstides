...
export default function TikTokTeaser() {
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-8 flex items-end justify-between">
          <div>
            ...
            <h2 className="mt-1 text-3xl font-black uppercase text-white">Latest on TikTok</h2>
          </div>
          <div className="flex items-center gap-4">
            ...
            <Link href="/tiktok" className="text-sm text-muted hover:text-white transition-colors">
              View all →
            </Link>
          </div>
        </div>
        ...
        >
          {VIDEOS.map((v) => (
            <Link
              ...
              style={{ width: '150px', aspectRatio: '9/16', scrollSnapAlign: 'start' }}
            >
              {/* Thumbnail — swap in once screenshots are in /public/tiktok/ */}
              <img
                src={v.thumb}
              ...
              <div className="absolute inset-0 -z-10 flex flex-col items-center justify-center gap-2 bg-gradient-to-b from-[#1a1a1a] to-[#0d0d0d]">
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-black/50 opacity-0 transition-opacity duration-200 group-hover:opacity-100">
                <div className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-white bg-black/40">
